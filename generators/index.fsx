...
let generate' (ctx: SiteContents) (_: string) =
    ...
    let desc, postPageSize, siteUrl =
        siteInfo
        |> Option.map (fun si -> si.description, si.postPageSize, si.siteUrl)
    ...
    psts
    |> List.mapi (fun i psts -> getFilenameForIndex i, layoutForPostSet i psts |> Layout.render ctx)
